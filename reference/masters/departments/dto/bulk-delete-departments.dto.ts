...
/**
 * Data Transfer Object for bulk deletion of departments.
 *
 * This DTO is used for operations that require deleting multiple departments
 * in a single request. It includes validation to ensure the operation is
 * safe and performant by limiting the number of departments that can be
...
export class BulkDeleteDepartmentsDto {
   ...
   *
   * Contains the unique identifiers of departments to be deleted.
