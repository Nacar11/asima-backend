...
export class AddHoldStatusInUserTable1762415588402
  implements MigrationInterface
{
  name = 'AddHoldStatusInUserTable1762415588402';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."user_status_enum" AS ENUM('Active', 'Cancelled', 'Hold')`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."user_status_enum_old" AS ENUM('Active', 'Cancelled')`,
    );
    await queryRunner.query(
      `ALTER TABLE "user" ALTER COLUMN "status" DROP DEFAULT`,
    );
