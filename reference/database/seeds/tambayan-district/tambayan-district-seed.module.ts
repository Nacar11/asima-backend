...
import { TambayanDistrictSeedService } from './tambayan-district-seed.service';
...
@Module({
  ...
  providers: [TambayanDistrictSeedService],
  exports: [TambayanDistrictSeedService],
})
export class TambayanDistrictSeedModule {}
