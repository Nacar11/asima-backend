...
import { BookingsSeedService } from '@/database/seeds/bookings/bookings-seed.service';
...
@Module({
  ...
  providers: [BookingsSeedService],
  exports: [BookingsSeedService],
})
export class BookingsSeedModule {}
