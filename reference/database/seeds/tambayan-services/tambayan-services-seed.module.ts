...
import { TambayanServicesSeedService } from './tambayan-services-seed.service';
...
@Module({
  ...
  providers: [TambayanServicesSeedService],
  exports: [TambayanServicesSeedService],
})
export class TambayanServicesSeedModule {}
