import { JournalEntryTransactionStatusEnum } from '@/utils/enums/accounting.enum';
...
export abstract class BaseTransactionEntityHelper extends BaseEntityHelper {
   ...
   *
   * @type {JournalEntryTransactionStatusEnum}
   * @memberof BaseTransactionalEntityHelper
   */
  @Column({
    type: 'enum',
    enum: JournalEntryTransactionStatusEnum,
    default: JournalEntryTransactionStatusEnum.NEW,
    nullable: false,
  })
  status: JournalEntryTransactionStatusEnum;
}
