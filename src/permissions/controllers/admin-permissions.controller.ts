...
/**
 * Admin endpoints for the Permission catalog.
 *
 * NOTE (v0): the auth guard and `@Permissions({ PERMISSION: 'View' })`
 * decorator land in Task 6 (PermissionsGuard wiring). For now these
 * routes are open — do not deploy this state.
 */
